<p align="center">
  <a href="https://github.com/microsoft/microsoft-store-apppublisher/actions"><img alt="microsoft-store-apppublisher status" src="https://github.com/microsoft/microsoft-store-apppublisher/workflows/build-test/badge.svg"></a>
</p>

# Setup MSStore Developer CLI

This repository contains the source code for the `microsoft-store-apppublisher` GitHub Action as well as the `microsoft-store-apppublisher` Azure DevOps extension.
